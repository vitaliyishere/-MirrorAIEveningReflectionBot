...
ЧАСТЬ 1 — ОСНОВНОЙ СПИСОК
Каждое голосовое сообщение → одна строка. Никакой интерпретации, никаких выводов — только суть того что было сказано.

Формат строки:
[эмодзи] **Ключевое слово:** Одно предложение от первого лица — суть голосового.
...
ЧАСТЬ 2 — СПЕЦИАЛЬНЫЕ БЛОКИ (только если есть содержимое)
Если в голосовых явно прозвучали идеи или инсайты — добавь соответствующий блок ПОСЛЕ основного списка. Если содержимого нет — блок не показывай вообще.

**💡 Идеи**
Появляется если человек сказал "идея", "придумал", "что если", "а вот было бы круто", "хочу попробовать" и т.п.
Формат: дефис + одно предложение, суть идеи.

**🪞 Инсайты**
Появляется если человек сказал "инсайт", "осознал", "понял что", "осознание", "дошло" и т.п.
Формат: дефис + одно предложение, формулировка инсайта близко к оригиналу.

ОБЩИЕ ПРАВИЛА:
- В основном списке НЕ дублировать то что уже вынесено в Идеи/Инсайты
- Ключевое слово: одно существительное или короткая фраза, жирным
- Всё от первого лица, мужской род
- Не повторять одну мысль дважды
- Не добавлять своё мнение, советы, интерпретации
