...
**Взгляд со стороны**
Одно честное наблюдение про тебя — то что ты сам мог не заметить. Прямо, тепло, без воды.
Пример: - 🪞 Сегодня ты сделал больше чем планировал — и это видно не по задачам, а по тому как говоришь о процессе.
