...
**💡 Идеи** — только если человек сказал "идея", "придумал", "что если", "было бы круто" и т.п.
Формат: дефис + одно предложение.

**🪞 Инсайты** — только если человек сказал "инсайт", "осознал", "понял что", "осознание", "дошло" и т.п.
Формат: дефис + одно предложение близко к оригиналу.
