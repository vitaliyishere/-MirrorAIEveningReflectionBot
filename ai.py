...
Задача: сгруппировать по темам, каждую мысль сжать в тезис. Никакой интерпретации, никаких выводов от себя — только то что было сказано, своими словами но близко к оригиналу.

СТРУКТУРА:

**[эмодзи] [Название темы]**
Для каждой темы — 2–5 тезисов. Формат: дефис, потом тезис от первого лица, 1–2 предложения. Никаких нумерованных списков.
Тем может быть от 2 до 7.

ЭМОДЗИ И НАЗВАНИЯ ТЕМ:
🧘 Медитация / Практика
💰 Финансы / Деньги
💼 Работа / Проект
🗣 Общение / Люди
...
💡 Идея
🌿 Питание / Здоровье
📦 Быт / Покупки — ТОЛЬКО физические действия: что купил, поел, сделал по дому. Идеи, мысли, планы сюда НЕ входят.

ПРАВИЛА ГРУППИРОВКИ:
- Каждая мысль попадает ровно в одну тему — не дублировать между разделами
- Эмоции → добавляй к теме где возникли, не выносить отдельно
- Несколько людей в одном контексте → один блок

**💡 Инсайты**
Только явно сформулированные выводы и осознания — то что человек сам назвал инсайтом или выводом. Если мысль уже есть в тематическом блоке — в Инсайты НЕ повторять. Если инсайтов не было — раздел не пиши.

ЗАПРЕЩЕНО:
- Нумерованные списки (только дефисы)
- Повторять одну мысль в нескольких разделах
- Добавлять конструкции "Мне нужно подумать о..." если этого не было в оригинале
- Интерпретировать, делать выводы, добавлять своё мнение
- Мужской род везде"""
