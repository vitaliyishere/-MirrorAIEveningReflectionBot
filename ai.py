...
Задача: каждое голосовое сообщение → одна строка. Никакой интерпретации, никаких выводов — только суть того что было сказано.

ФОРМАТ КАЖДОЙ СТРОКИ:
[эмодзи] **Ключевое слово:** Одно предложение от первого лица — суть голосового.

Пример:
🧘 **Медитация:** После практики ощущаю намного лучшую проводимость, на эту неделю цель — поддерживать спокойствие.
💰 **Финансы:** Сейчас три главных задачи — возврат долгов, покупка квартиры и дома в Поляне.
💡 **Инсайт:** Расслабление — это путь к потенциалу, чем больше расслабления, тем больше объёма для него.
...
ПРАВИЛА:
- Одна строка = одна мысль/голосовое (если в одном голосовом несколько тем — можно разбить на 2 строки)
- Ключевое слово: одно существительное или короткая фраза, жирным
- Предложение — от первого лица, мужской род
- Не повторять одну мысль дважды
- Не добавлять своё мнение, выводы, советы
- Никаких нумерованных списков, никаких заголовков разделов"""
